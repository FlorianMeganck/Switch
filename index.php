...
<div class="max-w-6xl mx-auto px-6 py-10 space-y-12">
    ...
    <!-- HERO (comme Vinted) -->
    <div class="bg-slate-100 rounded-3xl p-10 flex justify-between items-center">
        ...
        <div class="max-w-md">
            ...
            <p class="text-slate-600 mb-6">
                Des milliers d’articles à petits prix entre étudiants
            </p>
        ...
        <div class="hidden md:block">
            <img src="https://via.placeholder.com/250" class="rounded-xl">
        </div>
...
<!-- CARTE PRODUIT -->
        <div class="bg-white p-4 rounded-2xl shadow">
            <img src="https://via.placeholder.com/200" class="rounded-xl mb-3">
    ...
    <div class="text-center">
        <button class="bg-emerald-600 text-white px-6 py-3 rounded-xl font-bold">
            Voir plus
        </button>
    </div>

    <!-- PARTIE VUE JS (simple pour ton oral) -->
